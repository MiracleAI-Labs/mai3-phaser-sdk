...
export class EVMDemo extends BaseScene {
  label?: Label;
  ...
  private createButtons() {
    ...
    this.createConnectEVMWalletBtn();
  }

  private async createConnectEVMWalletBtn() {
    const btn = this.mai3.add.connectEVMWalletButton({
      x: 200,
      y: 300,
      width: 200,
      height: 70,
